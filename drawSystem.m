...
text(ax(1,1)+5, ax(2,1)+5, ax(3,1), '\{W/Cam1\}', 'FontSize',20)
...
plot3([ax(1,1) ax(1,3)],[ax(2,1) ax(2,3)],[ax(3,1) ax(3,3)],'g','linewidth',2)
plot3([ax(1,1) ax(1,4)],[ax(2,1) ax(2,4)],[ax(3,1) ax(3,4)],'b','linewidth',2)
text(ax(1,1)+5, ax(2,1)+5, ax(3,1), '\{Cam2\}', 'FontSize',20)
...
plot3([ax(1,1) ax(1,3)],[ax(2,1) ax(2,3)],[ax(3,1) ax(3,3)],'g','linewidth',2)
plot3([ax(1,1) ax(1,4)],[ax(2,1) ax(2,4)],[ax(3,1) ax(3,4)],'b','linewidth',2)
text(ax(1,1)+5, ax(2,1), ax(3,1), '\{T\}', 'FontSize',22)
...
plot3([ax(1,1) ax(1,3)],[ax(2,1) ax(2,3)],[ax(3,1) ax(3,3)],'g','linewidth',2)
plot3([ax(1,1) ax(1,4)],[ax(2,1) ax(2,4)],[ax(3,1) ax(3,4)],'b','linewidth',2)
text(ax(1,1)-15, ax(2,1), ax(3,1), '\{I\}', 'FontSize',24)
%%%%%%%%%%%%%%%%%%%%%%%%%%% Plot image plane
w = 40;
h = 80;
...
plot3([ax(1,1) ax(1,3)],[ax(2,1) ax(2,3)],[ax(3,1) ax(3,3)],'g','linewidth',2)
plot3([ax(1,1) ax(1,4)],[ax(2,1) ax(2,4)],[ax(3,1) ax(3,4)],'b','linewidth',2)
text(ax(1,1)+7, ax(2,1)+7, ax(3,1), '\{F\}', 'FontSize', 22)
